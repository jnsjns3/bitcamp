...
public class Test15_11_3{
    ...
    public static void main(String[] args) {
        ...
        final int OWNER_EXE = 0x0040; //0b0010_0100_0000;
        final int GROUP_READ = 0x0020; //0b0000_0010_0000;
        final int GROUP_WRITE = 0x0010; //0b0010_0001_0000;
        final int GROUP_EXE = 0x0008; //0b0000_0000_1000;
        final int OTHER_READ = 0x0004; //0b0000_0000_0100;
        final int OTHER_WRTIE = 0x0002; //0b0010_0000_0010;
        final int OTHER_EXE = 0x0001; //0b0010_0000_0001;
       ...
       System.out.print((p1 & OTHER_WRTIE) == OTHER_WRTIE ? "w":"-");
