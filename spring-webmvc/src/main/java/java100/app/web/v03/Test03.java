...
public class Test03 {
    ...
    public String m2(Map map) {
        ...
        //그리고 그 맵 객체에 값을 저장하면,
        // 프론트 컨트롤러가 그 맵에 저장된 값을 꺼내 다시 ServletRequest에 저장할 것이다. (약속되어 있슴)
    ...
    public String m3(Model model) {
        ...
        //그리고 그 Model 객체에 값을 저장하면,
        // 프론트 컨트롤러가 그 Model에 저장된 값을 꺼내 다시 ServletRequest에 저장할 것이다. (약속되어 있슴)
    ...
    public Map m4() {
        ...
        // Map 객체 값을 담아 리턴하면, 프론트 컨트롤러는 맵에 저장되어 있는 객체를 ServletRequest로 옮긴다.
        Map map = new HashMap<>();
        map.put("member", new Member("홍길동", 20, true));
        
        // view url을 리턴하지 못하기 떄문에 프론트 컨트롤러는 현재 url을 view url로 사용한다.
    ...
    public Model m5() {
        ...
        // Map 객체 값을 담아 리턴하면, 프론트 컨트롤러는 맵에 저장되어 있는 객체를 ServletRequest로 옮긴다.
        Model map = new ConcurrentModel();
        map.addAttribute("member", new Member("홍길동", 20, true));
